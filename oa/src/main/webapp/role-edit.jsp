...
<head>
    ...
    <script type="application/javascript">
        $(function () {
            ...
            $.ajax({
                type: 'GET',
                url: 'role/showOneRole',
                data: {"roleid":${param.roleid}},
                dataType: 'json',
                success:function(rs){
                    $("#roleid").val(rs.roleid);
                    $("#rolename").val(rs.rolename);
                    $("#roledis").val(rs.roledis);
                    if(rs.status == 1){
                    ...
                    var setting = {
                        ...
                        callback:{
                            onAsyncSuccess: function zTreeOnAsyncSuccess(event, treeId, treeNode, msg) {
                                ...
                                $(rs.roleSources).each(function(index,item){
                                    //获取我们要进行勾选的节点
...
<form name="form2" action="role/role-edit" method="post" id="form18">
    ...
    <table width="98%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D1DDAA" align="center"
        ...
        <tr bgcolor="#FAFAF1">
            <td height="28" colspan=4 align=center>
                &nbsp;
                <a href="javascript:void(0)" id="myButton" class="coolbg">保存</a>
