...
<script type="text/javascript">
        $(function(){
            ...
            $.ajax({
                type:'GET',
                url:'${pageContext.request.contextPath}/datacollect/getInfoGroup',
                dataType:'json',
                success:function(resultData){
                    $(resultData).each(function(index,item){
                          var datime=dateto(item.datime);
                          var option="<option value="+item.daid+">"+item.dacname+'--'+datime+"</oiption>";
                           $("#com").append(option);
                    });
                },
            });
        ...
        function showInfo(a){
            $.ajax({
                type:'GET',
                url:'${pageContext.request.contextPath}/datacollect/getOneByCname',
				data:{"daid":a},
                dataType:'json',
                success:function(resultData){
                     ...
                     $("#year1").val(dateto(resultData.datime));
                     ...
                     $("#build1").val(dateto(resultData.buildtime));
...
<div>
	...
	<table width="98%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D1DDAA" align="center" style="margin-top:8px">
		...
		<tr >
			...
			<td colspan=3 align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" >
				  <a href="#" id="attachment" readonly=""></a>
			</td>
		</tr>
...
<form name="form2" id="form17" action="${pageContext.request.contextPath}/indexvalue/saveIndexValueInfo" method="POST" enctype="multipart/form-data">
	    <!-- 向后台传递的关联外键 -->
