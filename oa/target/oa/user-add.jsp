...
<link rel="stylesheet" type="text/css" href="skin/css/base.css">
	...
	<script type="application/javascript">
          $(function(){
              ...
              $.ajax({
                  type:'GET',
                  url:'${pageContext.request.contextPath}/position/getPosition',
                  dataType:'json',
              ...
              $.ajax({
                  type:'GET',
                  url:'${pageContext.request.contextPath}/level/getLevel',
                  dataType:'json',
                  success:function(resultData){
                      $(resultData).each(function(index,item){
...
<form name="form2" action="employee/employee-addEmp" method="post" id="form19">
