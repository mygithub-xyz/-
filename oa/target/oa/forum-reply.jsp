...
<div>
    ...
    <form name="form2" action="../evaluate/evaluate-add" id="form15" method="post">
        <input type="hidden" name="forumFk" value="${forum.forumid}">
        <table width="98%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D1DDAA" align="center" style="margin-top:8px">
            ...
            <tr >
                ...
                <td  align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
                    <span>发布人：${forum.employeeExtends.ename}</span><br>
                    <span>发布时间：<fmt:formatDate value="${forum.createtime}" pattern="yyyy-MM-dd"></fmt:formatDate> </span><br>
                    <span>标题：${forum.forumtitle} </span><br>
                    <span>内容：${forum.forumcontent}</span>
                </td>
            </tr>
            <%--一级评论遍历--%>
            <c:forEach items="${forum.list}" var="evaluate">
                <tr >
                    <td align="right" bgcolor="#FAFAF1" height="22">
					<span >
						<img src='${pageContext.request.contextPath}/images/tx.png' height='50px' width='50px'/>
                    ...
                    <td  align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
                        <span>评论人：${evaluate.employeeExtends.ename}</span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <span>评论时间：<fmt:formatDate value="${evaluate.evatime}" pattern="yyyy-MM-dd"></fmt:formatDate> </span><br>
                        <span>评论内容：${evaluate.evacontent}</span>
                        <span><a href="../evaluate.jsp?forumid=${forum.forumid}&evaluateid=${evaluate.evaid}">【回复】</a></span>
                    </td>
                </tr>
                <c:forEach items="${evaluate.list}" var="evaSec">
                    <tr>
                        <td align="right" bgcolor="#FAFAF1" height="22">
					<span >
						<img src='${pageContext.request.contextPath}/images/tx.png' height='50px' width='50px'/>
                        ...
                        <td  align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
                            <span>${evaSec.employeeExtends.ename}&nbsp;回复了&nbsp;${evaluate.employeeExtends.ename}</span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <span>回复时间：<fmt:formatDate value="${evaSec.evatime}" pattern="yyyy-MM-dd"></fmt:formatDate> </span><br>
                            <span>回复内容:${evaSec.evacontent}</span>
                        </td>
                    </tr>
                </c:forEach>
