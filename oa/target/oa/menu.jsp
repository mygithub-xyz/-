...
<body target="main">
<p>${pageContext.request.contextPath}+/xmpic</p>
<table  width='99%' height="100%" border='0' cellspacing='0' cellpadding='0' >
    <tr>
        <td style='padding-left:3px;padding-top:8px' valign='top' id="menuss">
            ...
            <%--				<li><a href='project/project-model-show' target='main'>模块管理</a> </li>--%>
            <%--				<li><a href='project-function.jsp' target='main'>功能管理</a> </li>--%>
            <%--				<li><a href='project/project-attachment-show' target='main'>附件管理</a> </li>--%>
            <%--			</ul>--%>
            <%--		</dd>--%>
            <%--	  </dl>--%>
            ...
            <%--<li><a href='baoxiao/udobaoxiao?status=0' target='main'>报销审批</a> </li>--%>
            <%--<li><a href='baoxiao/mybaoxiao-show' target='main'>我的报销</a> </li>--%>
            <%--</ul></dd></dl>--%>
            ...
            <%--<li><a href='message/message-show' target='main'>消息推送</a> </li>--%>
            <%--<li><a href='forum/forum-show' target='main'>论坛</a> </li>--%>
            <%--</ul></dd></dl>--%>
            ...
            <%--<li><a href='customer/customer-search' target='main'>客户信息</a> </li>--%>
            <%--</ul></dd></dl>--%>
            ...
            <%--	<li><a href='employee/employee-show' target='main'>人员管理</a> </li>--%>
            <%--	<li><a href='pm.jsp' target='main'>权限维护</a> </li>--%>
            <%--	<li><a href='role/role-show' target='main'>角色管理</a> </li>--%>
            <%--</ul></dd></dl>--%>
...
<script type="text/javascript">
    $(function () {
        $.ajax({
            url:"employee/getSource-menu",
            dataType:"json",
            success:function (obj) {
                console.log(obj);
                $("#menuss").empty();
                $.each(obj.roleExtends.sourcesExtendsList,function (i, psource) {
                    var str = "";
                    $.each(psource.children,function (m, csource) {
                        s = "<li><a href='"+csource.url+"' target='main'>"+csource.name+"</a></li>";
                        str += s;
                    });
                    ...
                    $("#menuss").append(
                        "<dl class='bitem'>"+
                        "<dt onclick=showHide('items"+j+"_1')><b>"+psource.name+"</b></dt>"+
